...
var file_helloworld_conf_conf_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x6f, 0x2d, 0x61, 0x70, 0x70, 0x2f, 0x69, 0x6e, 0x74,
...
var file_helloworld_conf_conf_proto_goTypes = []any{
...
func file_helloworld_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_helloworld_conf_conf_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_helloworld_conf_conf_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Server); i {
			case 0:
				return &v.state
			case 1:
		...
		file_helloworld_conf_conf_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Data); i {
			case 0:
				return &v.state
			case 1:
		...
		file_helloworld_conf_conf_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_helloworld_conf_conf_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_helloworld_conf_conf_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_helloworld_conf_conf_proto_msgTypes[6].Exporter = func(v any, i int) any {
